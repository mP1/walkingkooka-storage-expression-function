...
/**
 * Lists the entries for a given {@link StoragePath}.
 */
final class StorageExpressionFunctionList<C extends StorageExpressionEvaluationContext> extends StorageExpressionFunction<C, StorageValueInfoList> {

    /**
     * Type safe getter.
     */
    static <C extends StorageExpressionEvaluationContext> StorageExpressionFunctionList<C> instance() {
